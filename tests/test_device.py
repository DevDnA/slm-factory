...
class TestDeviceInfo:
    ...
    def test_기본_gpu_count(self):
        ...
        info = DeviceInfo(
            type="cuda", name="test", dtype_name="bfloat16",
            bf16=True, fp16=True, quantization_available=True,
            device_map="auto",
        )
    ...
    def test_CPU_gpu_count_0(self):
        ...
        info = DeviceInfo(
            type="cpu", name="CPU", dtype_name="float32",
            bf16=False, fp16=False, quantization_available=False,
            device_map=None, gpu_count=0,
        )
...
class TestGetTrainingOverrides:
    ...
    def test_MPS_gradient_checkpointing_비활성(self):
        ...
        info = DeviceInfo(
            type="mps", name="M1", dtype_name="float16",
            bf16=False, fp16=True, quantization_available=False,
            device_map=None, gpu_count=1,
        )
        overrides = get_training_overrides(info)
